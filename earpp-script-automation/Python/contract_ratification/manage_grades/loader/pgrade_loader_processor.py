...
from loader.config import Colors, pgrade_base_loaders, pgrade_column_name_coor, pgrade_column_mapping_dict
...
class LoaderProcessor():
    def __init__(self, psbuild_type, file_id):
        ...
        process_folder = ".\loader/newfiles"
        
        self.path_excel = f'{process_folder}/Loader_{file_id}.xlsx'
        self.cloud_loader_path = f"{process_folder}/{pgrade_base_loaders[psbuild_type]}"
    ...
    def validate_loader_file(self):
        ...
        column_names_range = pgrade_column_name_coor[self.psbuild_type]
    ...
    def copy_cb_to_loader(self):
        ...
        matched_columns_name = [pgrade_column_mapping_dict[self.psbuild_type][loader_col_name.value] for loader_col_name in loader_col_names]
