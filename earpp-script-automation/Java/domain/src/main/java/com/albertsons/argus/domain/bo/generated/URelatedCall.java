...
public class URelatedCall {
    ...
    public String toString() {
        ...
        sb.append(URelatedCall.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof URelatedCall) == false) {
            return false;
        }
        URelatedCall rhs = ((URelatedCall) other);
