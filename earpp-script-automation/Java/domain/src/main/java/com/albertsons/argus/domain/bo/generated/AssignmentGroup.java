...
public class AssignmentGroup {
    ...
    public String toString() {
        ...
        sb.append(AssignmentGroup.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AssignmentGroup) == false) {
            return false;
        }
        AssignmentGroup rhs = ((AssignmentGroup) other);
