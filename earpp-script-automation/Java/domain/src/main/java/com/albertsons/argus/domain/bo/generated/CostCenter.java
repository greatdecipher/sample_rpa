...
public class CostCenter {
    ...
    public String toString() {
        ...
        sb.append(CostCenter.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CostCenter) == false) {
            return false;
        }
        CostCenter rhs = ((CostCenter) other);
