...
public class UReportedCi {
    ...
    public String toString() {
        ...
        sb.append(UReportedCi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UReportedCi) == false) {
            return false;
        }
        UReportedCi rhs = ((UReportedCi) other);
