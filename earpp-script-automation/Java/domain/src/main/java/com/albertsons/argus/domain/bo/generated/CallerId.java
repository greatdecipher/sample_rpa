...
public class CallerId {
    ...
    public String toString() {
        ...
        sb.append(CallerId.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CallerId) == false) {
            return false;
        }
        CallerId rhs = ((CallerId) other);
