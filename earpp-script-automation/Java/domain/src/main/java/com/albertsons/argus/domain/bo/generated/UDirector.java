...
public class UDirector {
    ...
    public String toString() {
        ...
        sb.append(UDirector.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UDirector) == false) {
            return false;
        }
        UDirector rhs = ((UDirector) other);
