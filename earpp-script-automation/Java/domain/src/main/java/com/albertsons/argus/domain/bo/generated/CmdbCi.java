...
public class CmdbCi {
    ...
    public String toString() {
        ...
        sb.append(CmdbCi.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof CmdbCi) == false) {
            return false;
        }
        CmdbCi rhs = ((CmdbCi) other);
