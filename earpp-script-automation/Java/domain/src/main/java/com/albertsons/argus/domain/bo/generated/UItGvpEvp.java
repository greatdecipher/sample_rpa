...
public class UItGvpEvp {
    ...
    public String toString() {
        ...
        sb.append(UItGvpEvp.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UItGvpEvp) == false) {
            return false;
        }
        UItGvpEvp rhs = ((UItGvpEvp) other);
