...
public class UKnowledgeArticle {
    ...
    public String toString() {
        ...
        sb.append(UKnowledgeArticle.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("link");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof UKnowledgeArticle) == false) {
            return false;
        }
        UKnowledgeArticle rhs = ((UKnowledgeArticle) other);
